...
- 动态载荷必须满足距离0～5000 mm、航向0～359.99°、直行/航向/距离有效位齐全。距离≤5 mm停车，停车后必须重新大于50 mm才恢复；任务命令超过250 ms立即停车；车辆前进时距离载荷连续500 ms没有至少2 mm变化会锁定等待，直到上位机距离重新变化，避免100 Hz心跳掩盖冻结的T265/融合位置。
...
- NAV接近放置区时仍由上位机在约250～300 mm处把heading切换为放置区方向（红90°/蓝270°）；F407检测到最新航向后先停车对正，进入最后300 mm时将NAV速度限制约400 mm/s，再走完余量并在D≤5 mm停车。F407不自行猜测红/蓝方向，最终航向仍来自上位机。
