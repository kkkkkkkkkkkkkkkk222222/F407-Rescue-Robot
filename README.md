...
- LCD地图按赛事图绘制四个300×300 mm出发区、上下两个约660×360 mm安全区、中心轴线，以及四个出发区两条场内方向上的全部减速带；黄色等腰三角形中心代表当前车体位置，两条相等短边在橙色车头顶点相交，较长底边代表车尾，绿色轨迹点保留最近48个实测位置。三角形根据IMU航向实时旋转，不是预先绘制的固定图标。
